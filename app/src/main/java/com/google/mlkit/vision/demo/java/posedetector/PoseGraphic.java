...
public class PoseGraphic extends Graphic {
  ...
  private static final float POSE_CLASSIFICATION_TEXT_SIZE = 52.0f;
  ...
  PoseGraphic(
    ...
    classificationTextPaint.setColor(Color.YELLOW);
  ...
  public void draw(Canvas canvas) {
    ...
    drawPoint(canvas, nose , nosePaint);
    // Left body
