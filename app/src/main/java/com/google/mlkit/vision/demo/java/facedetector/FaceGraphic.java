...
public class FaceGraphic extends Graphic {
  ...
  private static final float FACE_POSITION_RADIUS = 18.0f;
...
//        canvas.drawCircle(translateX(point.x), translateY(point.y), FACE_POSITION_RADIUS, facePositionPaint);
       Log.v("TEST", "Points of circle " + translateX(point.x) + "  " + translateY(point.y));
        Log.v("TEST", "ball position============================ " + ballx + "  " + bally);
//
